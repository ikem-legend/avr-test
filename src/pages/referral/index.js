	  		...
	  		<div className="">
			  	...
			  	<Row className="page-title align-items-center">
				  	<Col md={4} className="trading-rates">
				  		<p className="mb-0 mt-0 referral-head font-weight-bold">Help your friends get into crypto</p>
				  		<p className="mb-0 mt-0">Invite your friends and make $10 for you</p>
				  		<p className="mb-0 mt-0">and your friend each if they sign up</p>
				  		<p className="mb-0 mt-0">Set your referral URL <span className="referral-url">here</span></p>
				  	</Col>
				  	...
				  	<Col md={3} className="text-center">
				  		<div className="">
				  			<Button block className="btn-red" size="lg">Share Referral Link</Button>
				  		</div>
				  	</Col>
			  	</Row>
			  	<Row>
