...
const DocumentUpload = ({userDocumentModal, userDocument, toggleImgUpload, handleUserDocument, submitUserDocument, loadingUpload}) => {
  const [activeTab, setActiveTab] = useState('1')
	return (
      ...
      <ModalHeader className="account-link-header mx-auto pb-0">Upload User Identification</ModalHeader>
        ...
        <Row>
          <Col md={12} className="text-center">
            <p className="mb-1 font-italic text-muted">PS - You will be unable to make cryptocurrency investments without an ID</p>
          </Col>
        </Row>
		    {loadingUpload ? (
		      <img
